...
REM
REM Generated by Vivado on Sat Aug 30 17:31:31 +0700 2025
...
echo "xvhdl --incr --relax -prj counter_test_bench_vhdl.prj"
call xvhdl  --incr --relax -prj counter_test_bench_vhdl.prj -log xvhdl.log
