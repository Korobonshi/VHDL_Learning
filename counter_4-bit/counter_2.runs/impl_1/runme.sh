...
HD_PWD='E:/Xilinx_project/counter_2/counter_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter_4bit.tcl -notrace
