...
HD_PWD='E:/Xilinx_project/counter_2/counter_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_4bit.tcl
