...
HD_PWD='D:/SKRIPSI/Perkembangan_14_MEI_2025/UART_RX/VHDL/Pengiriman_UART_RX_5_Mei_2025/Pengiriman_UART_RX_5_Mei_2025.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_RX.tcl
