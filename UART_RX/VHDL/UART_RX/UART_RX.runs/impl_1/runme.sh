...
HD_PWD='D:/SKRIPSI/Perkembangan_14_MEI_2025/UART_RX/VHDL/Pengiriman_UART_RX_5_Mei_2025/Pengiriman_UART_RX_5_Mei_2025.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_RX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_RX.tcl -notrace
