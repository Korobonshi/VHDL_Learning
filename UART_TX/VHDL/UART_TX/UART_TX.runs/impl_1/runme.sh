...
HD_PWD='D:/SKRIPSI/Perkembangan_14_MEI_2025/UART_TX/VHDL/UART_TX_9_MEI_2025/UART_TX_9_MEI_2025.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_TX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_TX.tcl -notrace
