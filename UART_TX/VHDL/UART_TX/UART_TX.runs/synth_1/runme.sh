...
HD_PWD='D:/SKRIPSI/Perkembangan_14_MEI_2025/UART_TX/VHDL/UART_TX_9_MEI_2025/UART_TX_9_MEI_2025.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_TX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_TX.tcl
