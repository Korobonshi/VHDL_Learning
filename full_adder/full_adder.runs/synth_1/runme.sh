...
HD_PWD='E:/Xilinx_project/full_adder/full_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FULL_ADDER_32_Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FULL_ADDER_32_Bit.tcl
