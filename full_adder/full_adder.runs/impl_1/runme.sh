...
HD_PWD='E:/Xilinx_project/full_adder/full_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FULL_ADDER_32_Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FULL_ADDER_32_Bit.tcl -notrace
